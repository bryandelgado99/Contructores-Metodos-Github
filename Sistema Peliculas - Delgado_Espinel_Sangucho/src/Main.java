...
public class Main {
    public static void main(String[] args) {
        ...
        Peliculas film12 = new Peliculas("The Batman", "Matt Reeves", "Robert Pattinson",
                "Warner Bros", "Ciencia Ficcion, Detectives, Superhéroes", "Estados Unidos", 2022, "770 millones");
